...
export const BMS_BUILDINGS: BmsBuilding[] = [
  { id: "terminal-t1", name: "Passenger Terminal T1" },
  { id: "utility-plant", name: "Central Utility Plant" },
  { id: "mini-dc", name: "Airport Mini Data Center" },
];

/** Airport zones that contain the currently viewed equipment type. */
...
/** Airport-specific location metadata used by the EBO / BMS workflow. */
...
export const ASSET_LOCATION_INFO: Record<string, AssetLocationInfo> = {
  ahu:     { code: "GBIA-AHU-T1-L2-01", building: "Passenger Terminal T1", floor: "Level 2", area: "East Mechanical Zone" },
  fcu:     { code: "GBIA-FCU-T1-L2-18", building: "Passenger Terminal T1", floor: "Level 2", area: "Retail Concourse B" },
  vav:     { code: "GBIA-VAV-T1-L3-05", building: "Passenger Terminal T1", floor: "Level 3", area: "Boarding Zone C" },
  chiller: { code: "GBIA-CH-PLANT-01", building: "Central Utility Plant", floor: "B1", area: "Chiller Hall" },
  "plate-heat-exchanger": { code: "GBIA-PHX-PLANT-02", building: "Central Utility Plant", floor: "B1", area: "Heat Exchange Room" },
  "crah-unit": { code: "GBIA-CRAH-DC-03", building: "Airport Mini Data Center", floor: "Level 1", area: "Data Hall 1" },
};
