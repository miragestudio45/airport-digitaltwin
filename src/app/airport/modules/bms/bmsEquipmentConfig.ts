 ...
 * Source: https://bms-ioc-danang-vercel-updated.vercel.app/manifest.json (v1.1.0)
 *
 * ASSET_BASE_URL → updated Vercel deployment.
 * All GLB URLs are resolved from relative manifest paths using resolveModelUrl().
 * Do NOT use Google Drive, local /public paths, or the old vercel.app URL.
 */
